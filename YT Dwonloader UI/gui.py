...
def main(page: ft.Page):
    page.title = "Mr.Dollars YT Downloader"
    ...
    def on_complete(*args):
        download_complete.value = "Download Completed"
        page.update()

    def handle_error(*args):
        download_complete.value = "Something went wrong, please try again"
        page.update()
    ...
    selected_path.value = "Select Save Location"

    download_button = ft.TextButton("Start Download", on_click=handle_submit)
